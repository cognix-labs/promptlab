...
async def main():
    ...
    prompt_template = PromptTemplate(
        name="async_deepseek_example_" + str(int(time.time())),  # Add timestamp to make name unique
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run PromptLab in async mode with DeepSeek models")
    parser.add_argument("--model", type=str, help="DeepSeek model name")
    parser.add_argument("--embedding-model", type=str, help="DeepSeek embedding model name")
