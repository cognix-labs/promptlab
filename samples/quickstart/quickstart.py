...
def dummy_target(inputs: dict) -> ModelResponse:
    ...
    return ModelResponse(inference = "This is a dummy target function that returns a static response.", prompt_tokens=0, completion_tokens=0, latency_ms=0)
