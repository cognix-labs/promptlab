...
class SQLiteTracer(Tracer):
    ...
    def trace(
        ...
        inference_model_config = vars(experiment_config.inference_model.model_config) if experiment_config.inference_model else None
        embedding_model_config = vars(experiment_config.embedding_model.model_config) if experiment_config.embedding_model else None
        ...
        asset = {
            "prompt_template_name": experiment_config.prompt_template.name if experiment_config.prompt_template else None,
            "prompt_template_version": experiment_config.prompt_template.version if experiment_config.prompt_template else None,
